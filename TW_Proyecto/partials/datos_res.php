    ...
    <?php
        ...
        <div class="formulario-editar">
            <form action="" method="POST">
                <label>Email:
                    <input type="text" name="numero" value="<?php echo $_SESSION['reservas_borrar']['email']; ?>" disabled>
                </label>

                <label>Numero-Habitacion:
                    <input type="text" name="numero" value="<?php echo $_SESSION['reservas_borrar']['numero']; ?>" disabled>
                </label>

                <label>Capacidad:
                    <input type="text" name="capacidad" value="<?php echo $_SESSION['reservas_borrar']['capacidad']; ?>" disabled>
                </label>
 
                <label>Descripción:
                    <textarea name="descripcion" disabled><?php echo $_SESSION['reservas_borrar']['comentarios']; ?></textarea>
                </label>

                <label>Día de entrada:
                    <input type="text" name="precio" value="<?php echo $_SESSION['reservas_borrar']['dia_entrada']; ?>" disabled>
                </label>

                <label>Día de salida:
                    <input type="text" name="precio" value="<?php echo $_SESSION['reservas_borrar']['dia_salida']; ?>" disabled>
                </label>
